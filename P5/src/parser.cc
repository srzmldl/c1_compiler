...
{
       0,    46,    46,    50,    54,    60,    64,    70,    74,    83,
      87,    95,    99,   103,   109,   115,   119,   127,   131,   135,
     139,   143,   149,   153,   161,   167,   173,   177,   181,   192,
     196,   202,   206,   210,   214,   218,   222,   226,   233,   239,
     243,   250,   254,   258,   262,   266,   270,   276,   281,   286,
     291,   298,   303,   309,   315,   321,   326,   331,   340,   346,
     352,   358
};
#endif
...
#line 1512 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1530 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 60 "config/parser.y" /* yacc.c:1646  */
    ...
    (yyval.node) = (DeclNode*)(yyvsp[0].node);
     }
...
#line 1548 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 70 "config/parser.y" /* yacc.c:1646  */
    ...
    (yyval.node) = new ConstDeclNode(((ConstDefNode*)(yyvsp[-1].node))->constHead);
     }
#line 1557 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1569 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 83 "config/parser.y" /* yacc.c:1646  */
    ...
    (yyval.node) = (ConstDefNode*)(yyvsp[0].node);
     }
#line 1578 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 87 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = (ConstDefNode*)(yyvsp[0].node);
        ((ConstDefNode*)(yyvsp[-2].node))->constNext = (ConstDefNode*)(yyvsp[0].node);
        ((ConstDefNode*)(yyval.node))->constHead = ((ConstDefNode*)(yyvsp[-2].node))->constHead;
          }
...
#line 95 "config/parser.y" /* yacc.c:1646  */
    ...
    (yyval.node) = new ConstDefEleNode((IdentNode*)(yyvsp[-2].node), (ExpNode*)(yyvsp[0].node));
    }
...
#line 99 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new ConstDefArrLimNode((IdentNode*)(yyvsp[-7].node), (ExpNode*)(yyvsp[-5].node), (MultiExpNode*)(yyvsp[-1].node));
          }
#line 1607 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 103 "config/parser.y" /* yacc.c:1646  */
    {
        debug("(%d,%d)ConstDef ::= ident_tok [ Exp ] = { MultiExp }\n", (yyloc).first_line, (yyloc).first_column);
        (yyval.node) = new ConstDefArrNoLimNode((IdentNode*)(yyvsp[-6].node), (MultiExpNode*)(yyvsp[-1].node));
          }
...
#line 109 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new VarDeclNode(((VarDefNode*)(yyvsp[-1].node))->varHead);
          }
...
#line 119 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        ((VarDefNode*)(yyvsp[-2].node))->varNext = (VarDefNode *)(yyvsp[0].node);
        (yyval.node) = (yyvsp[0].node);
        ((VarDefNode*)(yyval.node))->varHead = ((VarDefNode *)(yyvsp[-2].node))->varHead;
          }
...
#line 131 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new VarDefArrLimNoEquNode((IdentNode *)(yyvsp[-3].node), (ExpNode *) (yyvsp[-1].node));
          }
...
#line 135 "config/parser.y" /* yacc.c:1646  */
    {
        debug("(%d,%d)Var :: =  ident_tok = Exp\n", (yyloc).first_line, (yyloc).first_column);
        (yyval.node) = new VarDefEleEquNode((IdentNode*)(yyvsp[-2].node), (ExpNode*) (yyvsp[0].node));
           }
...
#line 139 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new VarDefArrLimEquNode((IdentNode*) (yyvsp[-7].node), (ExpNode*) (yyvsp[-5].node), (MultiExpNode*) (yyvsp[-1].node));
          }
...
#line 143 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new VarDefArrNoLimEquNode((IdentNode*)(yyvsp[-6].node), (MultiExpNode*) (yyvsp[-1].node));
          }
...
#line 149 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = (ExpNode*) (yyvsp[0].node))->expHead;
          }
...
#line 153 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        ((ExpNode *)(yyvsp[-2].node))->nextExp = (ExpNode*)(yyvsp[0].node);
        (yyval.node) = (ExpNode*) (yyvsp[0].node);
        ((ExpNode *)(yyval.node))->headExp = ((ExpNode*)(yyvsp[-2].node))->headNode;
          }
#line 1710 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1719 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 167 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new BlockNode(((BlockItemNode*) (yyvsp[-1].node))->head);
          }
...
#line 1737 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 177 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = (BlockItemNode*) (yyvsp[0].node);
          }
#line 1746 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 181 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        ((BlockItemNode*)(yyvsp[-1].node))->next = (BlockItemNode*)(yyvsp[0].node);
          } else {
        ((BlockItemNode*)(yyval.node))->head = ((BlockItemNode*)(yyvsp[-1].node))->head;
          }
          }
...
#line 1769 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 202 "config/parser.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = new AssignStmtNode((LValNode*)(yyvsp[-3].node), (ExpNode*)(yyvsp[-1].node));
          }
...
#line 233 "config/parser.y" /* yacc.c:1646  */
    {
        (yyval.node) = new CondNode((ExpNode*) (yyvsp[-2].node), (yyvsp[-1].name), (ExpNode*) (yyvsp[0].node));
...
#line 243 "config/parser.y" /* yacc.c:1646  */
    {
        (yyval.node) = new RefArrNode((IdentNode*)(yyvsp[-3].node), (ExpNode*)(yyvsp[-1].node));
...
#line 1877 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1895 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1913 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1932 "src/parser.cc" /* yacc.c:1646  */
    break;

  case 48:
#line 281 "config/parser.y" /* yacc.c:1646  */
    {
            //$$ = 0;
        (yyval.node) = (yyvsp[0].node);
        debug("(%d,%d)Exp ::= LVal\n", (yyloc).first_line, (yyloc).first_column);
      }
#line 1942 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1952 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1972 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1982 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 1993 "src/parser.cc" /* yacc.c:1646  */
    break;

  case 54:
#line 315 "config/parser.y" /* yacc.c:1646  */
    {
            //$$ = workBrackTwo($1, $3);
...
#line 2004 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 2014 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 2024 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 2037 "src/parser.cc" /* yacc.c:1646  */
    break;

  case 58:
#line 340 "config/parser.y" /* yacc.c:1646  */
    {
...
#line 2048 "src/parser.cc" /* yacc.c:1646  */
    break;
...
#line 2082 "src/parser.cc" /* yacc.c:1646  */
      default: break;
    }
...
#line 364 "config/parser.y" /* yacc.c:1906  */
